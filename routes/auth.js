// 필요한 라이브러리들을 가져옵니다
const express = require('express');        // 웹 서버를 만드는 도구
const jwt = require('jsonwebtoken');       // 사용자 인증을 위한 토큰을 만드는 도구
const Joi = require('joi');               // 입력 데이터를 검증하는 도구
const User = require('../models/User');    // 사용자 데이터 모델
const { authenticateToken } = require('../middleware/auth'); // 사용자 인증 미들웨어
